...
class GRPOTrainer(BaseTrainer):
    ...
    def __init__(
        ...
        ratio = self.state.global_step / self.num_dataset
        if ratio > 1.0:
            ratio = 1.0
        self.epsilon_current = self.epsilon_high - (self.epsilon_high - self.epsilon_low) * ratio
        ...
        if self.use_liger_kernel:
            ...
            self.liger_grpo_loss = LigerFusedLinearGRPOLoss(
                ...
                epsilon_high=self.epsilon_current,
    ...
    def _compute_loss(self, model, inputs):
        ...
        coef_2 = torch.clamp(coef_1, 1 - self.epsilon_low, 1 + self.epsilon_current)
        ...
        is_high_clipped = (coef_1 > 1 + self.epsilon_current) & (advantages.unsqueeze(1) > 0)
